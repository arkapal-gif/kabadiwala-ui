...
const resources = {
  en: {
    translation: {
      ...
      selectScrap: "Step 1: Select scrap types to estimate value",
      estWeight: "Estimated Weight (kg)",
      totalValue: "Total Value:",
      nextStep: "Next Step",
      backBtn: "Back",
      personalDetails: "Step 2: Pickup Details",
      fullName: "Full Name",
      mobileNumber: "Mobile Number",
      exactAddress: "Exact Address / Flat No.",
      getGps: "Auto-fill GPS",
      location: "Location",
      addPhoto: "Upload Waste Photo (Required)",
      schedulePickup: "Confirm & Schedule Pickup",
  ...
  hi: {
    translation: {
      ...
      selectScrap: "चरण 1: मूल्य का अनुमान लगाने के लिए कबाड़ चुनें",
      estWeight: "अनुमानित वजन (किग्रा)",
      totalValue: "कुल मूल्य:",
      nextStep: "अगला चरण",
      backBtn: "पीछे",
      personalDetails: "चरण 2: पिकअप विवरण",
      fullName: "पूरा नाम",
      mobileNumber: "मोबाइल नंबर",
      exactAddress: "सटीक पता / फ्लैट नंबर",
      getGps: "जीपीएस भरें",
      location: "स्थान",
  ...
  bn: {
    translation: {
      ...
      selectScrap: "ধাপ 1: মূল্য অনুমান করতে স্ক্র্যাপ নির্বাচন করুন",
      estWeight: "আনুমানিক ওজন (কেজি)",
      totalValue: "মোট মূল্য:",
      nextStep: "পরবর্তী ধাপ",
      backBtn: "পিছনে",
      personalDetails: "ধাপ 2: পিকআপের বিবরণ",
      fullName: "পুরো নাম",
      mobileNumber: "মোবাইল নম্বর",
      exactAddress: "সঠিক ঠিকানা / ফ্ল্যাট নম্বর",
